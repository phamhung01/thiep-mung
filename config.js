const nameGirl = 'Thảo Linh';
const giftUrl = 'http://nodemy.vn';
const eventName = 'Anh yêu em nhiều lắm';
const titleCard = 'Tặng người ấy';
const contentCard = 'Chúc bé Linh của anh một ngày tràn ngập niềm vui và những nụ cười. Mong điều đẹp nhất sẽ đến với em trong hôm nay và cả những ngày sau';
